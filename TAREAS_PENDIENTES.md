...
|---|---|---|---|
| 2026-09-14 | `ACH-28192` (contrato `00309045`, Late Payment Fee $49) — posible cobro duplicado real | 3 pagos `ACH TRANSMITTED` en curso sobre una orden cuyo pago original ya se había aceptado, más una nota manual previa de "REFUND POR AJUSTE DE ABONO CLIENTE 22/23 JULIO" — no se tocó, la validation rule bloqueó la cancelación automática correctamente | Esperando que Carlos lo revise directamente — es el único de 25 que no se pudo backfillear |
