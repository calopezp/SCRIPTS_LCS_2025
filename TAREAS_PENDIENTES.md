...
| 2026-09-14 | Contrato `00317534`: `ACH-27859` (Late payment fee, $84.5 = mitad de AC $59.5 + $25 penalidad) sigue `Initiated` sin `SM_Next_Transaction_Date__c` — Carlos dice "solo era activar el ACH order para cobro" pero en Salesforce sigue sin fecha asignada | Confirmar si Carlos ya lo activó por otro medio, o si hace falta ponerle fecha de próxima transacción (mismo caso que se resolvió antes con 00318139) | Esperando aclaración de Carlos |
