...
TMP_APEX="$(mktemp -u /tmp/ach_apex_XXXXXX.apex)"
...
# Salesforce (bug real detectado 2026-09-07 en update_check_collection.apex:
# 161 pagos quedaron sin aplicar pese al resumen en verde; misma logica
# vulnerable aca). Se busca una de las dos lineas de cierre normal del
# script Apex; si ninguna aparece, algo aborto la ejecucion a mitad de camino
# (excepcion, limite de gobernador, etc).
REAL_FAILURE=0
