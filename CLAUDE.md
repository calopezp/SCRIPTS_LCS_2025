...
El usuario (calopezp) trabaja este repo desde dos computadoras, sincronizadas vía GitHub
(`https://github.com/calopezp/SCRIPTS_LCS_2025.git`, rama `main`):
...
- **NUEVA** — `C:\LCS 2026\SCRIPTS_LCS_2025\` — el nombre del remoto es config local de git y puede
  ser distinto al de ANTIGUA; confirmar con `git remote -v` antes de asumir el nombre.
